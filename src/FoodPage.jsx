...
const FoodPage = () => {
  ...
  const foodData = [
    { id: 1, type: "Vegetarian", description: "Today vegetarian food plan for diet", date: "Today", image:vegImg,Link:'/today' },
    { id: 2, type: "Non-Vegetarian", description: "Today non-vegetarian food plan for diet", date: "Today", image:nonvegImg, Link:'/today' },
    { id: 3, type: "Vegan", description: "Today vegan food plan for diet", date: "Today", image: veganImg,Link:'/today'  },
  ];
  ...
  return (
    <div className="food-page">
      ...
      <div className="food-list">
        {foodData.map((food) => (
          <div key={food.id} className="food-card" onClick={()=>navigate(food.Link)}>
